...
🕒AIM : 
       To implement the First Fit heuristic for the Bin Packing Problem, which assigns each item to the first available 
        bin with sufficient remaining capacity in order to reduce the total number of bins used.
