...
🕒Aim :
       To implement the Fractional Knapsack Problem using the Greedy Method in order to maximize
        the total value of items placed in a knapsack with a given capacity.
